...
data <- reactive({
  read.csv("C:/Users/user/Downloads/УЁБА/your_updated_file.csv") %>%
...
extract_ingredients_cleaned <- function(text) {
  ...
  cleaned_list <- sapply(ingredients_list, function(x) {
    x <- str_remove_all(x, "\\d+|\\b(g|kg|ml|tbsp|tsp|cup|cups|oz|lbs?|pounds?|tablespoons?|teaspoons?|cloves?|pieces?)\\b|\\b(large|small|of)\\b|/")
    str_trim(x)
  })
...
### <font sixe='5'>**https://www.put.poznan.pl/** </font>
